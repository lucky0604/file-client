...
class MyListCtrl(wx.ListCtrl):
    def __init__(self, parent, id):
        ...
        files = os.listdir('.')
        # images = ['images/empty.png', 'images/folder.png', 'images/source_py.jpg', 'images/image.png', 'images/pdf.png', 'images/up16.png']
        ...
        for i in files:
            ...
            if (j % 2) == 0:
                self.SetItemBackgroundColor(j, '#e6f1f5')
            j += 1
...
class FileHunter(wx.Frame):
    def __init__(self, parent, id, title):
        ...
        tb.AddSimpleTool(10, 'Previous')
        tb.AddSimpleTool(20,  'Up one directory')
        tb.AddSimpleTool(30, 'Home')
        tb.AddSimpleTool(40, 'Refresh')
        tb.AddSeparator()
        tb.AddSimpleTool(50, 'Editor')
        tb.AddSimpleTool(60, 'Terminal')
        tb.AddSeparator()
        tb.AddSimpleTool(70, 'Help')
        tb.Realize()
